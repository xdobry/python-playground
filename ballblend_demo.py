...
def main():
    ...
    balls = []
    balls.append(Ball((320,224),(-3,2),pygame.Color(0,0,255)))
    ...
    blendScreen = pygame.Surface(screenRect.size,pygame.SRCALPHA)
    blendScreen.fill(pygame.Color(4,4,4,0))
    ...
    while running:
        ...
        screen.blit(blendScreen,(0,0),special_flags=pygame.BLEND_RGBA_SUB)
        group.update()
